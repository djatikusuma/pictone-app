			...
			<div class="ui purple segment">
                ...
                <div class="ui two column doubling stackable grid">
                    <div class="eight wide column">
                        <h4>Backup Database Pictone</h4>
                        <a href='<?=base_url("for_admin/database/backup");?>' class="circular ui icon button teal fluid">
                            Backup
                        </a>
                    </div> 
                    <div class="eight wide column">
                        <h4>Restore Database Pictone</h4>
                        <a href='#' id="restore" class="circular ui icon button orange fluid">
                            Restore
                        </a>
                    </div>                
                </div>
